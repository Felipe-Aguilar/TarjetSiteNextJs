    ...
    return ( 
        <div className={`body ${style.Directory}`}>
            ...
            <div className={style.Video}>
                <video width="1100" height="360" autoPlay preload="none" className={style.VideoDesk}>
                    <source src="/images/video-directorio.mp4" type="video/mp4" />
                    Tu navegador no soporta etiquetas de video.
                </video>

                <video width="1000" height="720" autoPlay preload="none" className={style.VideoMobile}>
